...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-0pc29tu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-0pc29tu.containers.anotherwebservice.com/
...
```
git clone git@github.com:d1g1entr0py/container-0pc29tu.git
cd container-0pc29tu
```
...
```
docker attach container-0pc29tu
```
